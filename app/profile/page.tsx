...
function ProfileContent() {
  ...
  return (
    ...
    <MobileContainer className="overflow-hidden">
      ...
      <div className="relative w-full h-screen bg-black rounded-[28px] overflow-y-auto" style={{ paddingBottom: '80px' }}>
        ...
        <header className="relative w-full">
          ...
          {/* Profile Text - aligned with icons - Responsive */}
          <div 
        ...
        <div className="relative w-full" style={{ marginTop: 'clamp(130px, 17.7vh, 139.75px)', padding: 'clamp(20px, 5.3vw, 26px)' }}>
          ...
          <div
            style={{
              ...
              marginBottom: 'clamp(16px, 4.3vw, 20px)',
              display: 'flex',
          ...
          >
            ...
            <div
              ...
              style={{
                width: 'clamp(100px, 26.7vw, 120px)',
                height: 'clamp(100px, 26.7vw, 120px)',
                borderRadius: '50%',
            ...
            <button
              style={{
                ...
                borderRadius: '15px',
                background: 'linear-gradient(135deg, rgba(31, 147, 242, 0.6) 0%, rgba(97, 197, 249, 0.6) 100%)',
          ...
          >
            ...
            >
              ...
              <ChevronRight size={20} style={{ color: 'rgba(216, 216, 216, 0.5)' }} />
            </div>
        ...
        >
          ...
          >
            ...
            >
              {/* QR Code */}
              <QRCodeSVG
                value={`MSCA-USER-PROFILE-${new Date().getTime()}`}
                size={240}
                level="H"
                includeMargin={false}
                style={{
